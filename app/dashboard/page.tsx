// Caminho do arquivo: app/dashboard/page.tsx (Modal Manual com Tailwind)
'use client'
...
// NÃO importamos mais Dialog, DialogContent, etc.
...
export default function DashboardPage() {
  ...
  const [isAddNcModalOpen, setIsAddNcModalOpen] = useState(false); // Renomeado para clareza
  ...
  return (
    <div className="container mx-auto p-4 md:p-6 lg:p-8">
      ...
      <section>
        <div className="mb-4 flex items-center justify-between">
            <h2 className="text-xl font-medium">Notas de Crédito Recebidas</h2>
             {/* --- Botão agora chama a função para abrir o modal manual --- */}
      ...
      {/* --- Modal Manual Renderizado Condicionalmente --- */}
      {isAddNcModalOpen && (
        // Overlay escuro
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          ...
          <div className="w-full max-w-xl rounded-lg bg-white p-6 shadow-xl max-h-[90vh] overflow-y-auto">
             <div className="mb-4 flex items-center justify-between">
                <h3 className="text-lg font-semibold">Cadastrar Nova Nota de Crédito</h3>
                {/* Botão X para fechar (opcional, pois o form tem cancelar) */}
                {/* <Button variant="ghost" size="icon" onClick={closeAddNcModal}> X </Button> */}
             </div>
