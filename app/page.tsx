// Caminho do arquivo: app/page.tsx (Atualizado com Logo)
'use client'
...
const DOMAIN_SUFFIX = '@salc.com'; // Mantém o sufixo anterior ou ajuste se necessário
...
export default function LoginPage() {
  ...
  return (
    // Usa flex-col para empilhar logo e card
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 p-4">
       ...
       <div className="mb-8">
            <Image
                ...
                height={120} // Mantenha a proporção ou ajuste
      ...
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold"> {/* Tamanho ajustado */}
          ...
          <form onSubmit={handleSignIn}>
            <div className="grid w-full items-center gap-4">
              <div className="flex flex-col space-y-1.5">
                ...
                <Input
                  id="username" type="text" placeholder="Seu nome de usuário"
      ...
      {/* Rodapé é gerenciado pelo layout.tsx */}
    </div>
  )
}